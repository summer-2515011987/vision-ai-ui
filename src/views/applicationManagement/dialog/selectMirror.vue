<template>
  ...
  >
    ...
    >
      ...
      <el-table-column label="镜像url" prop="mirrorUrl"> </el-table-column>
      <el-table-column label="版本" prop="edition">
        <template slot-scope="scope">{{ scope.row.edition }}</template>
      </el-table-column>
      <el-table-column label="描述" prop="dec">
        <template slot-scope="scope">{{ scope.row.dec }}</template>
      </el-table-column>
    </el-table>
    <el-pagination
